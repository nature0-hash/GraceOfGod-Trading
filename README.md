...
- `.orbit-system` rotates 0 → 360deg over 38s (linear, infinite)
- `.orbit-card-upright` counter-rotates 0 → -360deg over 38s, keeping cards upright
...
© GRACEOFGOD TRADING AND LOGISTICS LIMITED. All rights reserved.
